...
static struct msm_bus_paths bw_level_tbl[] = {
	...
	[5] = BW_MBPS(3280), /* At least 410 MHz on bus. ((2480*360)/310)*/
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_1566mhz[] = {
  ...
  { {1, 1},  486000,  ACPU_SCPLL, 0, 0, 1, 0x09, L2(2),   837500, 0x03006000},
  ...
  { {1, 1},  918000,  ACPU_SCPLL, 0, 0, 1, 0x11, L2(10),  925000, 0x03006000},
